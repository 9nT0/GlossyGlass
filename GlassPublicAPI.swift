...
@objc public class GlossyGlassAPI: NSObject {
    ...
    @objc public func isChromeAttached() -> Bool { GlassDiagnostics.shared.chromeSurfaces > 0 }
    @objc public func chromeSurfacesCount() -> Int { GlassDiagnostics.shared.chromeSurfaces }
    @objc public func activeSurfaceName() -> String { GlassSurfaceRouter.shared.activeSurfaceName }
    @objc public func reassertChrome() { GlassChromeShell.shared.reassert() }
