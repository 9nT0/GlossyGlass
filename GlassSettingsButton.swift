...
private class GlassSettingsViewController: UIViewController {
    ...
    private func buildUI() {
        ...
        systemCard.addArrangedSubview(makeDivider())
        systemCard.addArrangedSubview(makeSwitchRow(title: "Focus Mode", subtitle: "Extra dim for reading", isOn: GlassLiveState.shared.focusMode) { [weak self] on in
        ...
        systemCard.addArrangedSubview(makeDivider())
        systemCard.addArrangedSubview(makeSwitchRow(title: "Force Show Glass Button", subtitle: "Settings button only — not chrome", isOn: prefs.forceShowGlassButton) { [weak self] on in
        ...
        systemCard.addArrangedSubview(makeDivider())
        systemCard.addArrangedSubview(makeSwitchRow(title: "Exclusive Chrome", subtitle: "Strip IG bar fills — GG materials only", isOn: prefs.exclusiveChrome) { [weak self] on in
            self?.prefs.exclusiveChrome = on
